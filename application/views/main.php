        ...
        <div class="col-xs-12">
            <div class="jumbotron">
                <?php if (isset($_SESSION['username'])): ?>
                    <div class="hello"><b>Привет, <i class="username"><?php echo $_SESSION['username'];?></i></b><a class ="back" href ="/logout"> (Выход)</a></div>
                <?php endif; ?>
                <h1>Список заданий Todo</h1>
            </div>
        </div>
    </div><!--row -->
    <div class="row">
        <div class="col-md-6">
            <div class="panel">
                <div class="panel-heading head">
                    <h2>Добавьте ваше задание :</h2>
                </div>
                <div style="text-align: center" class="panel-body">
                    <form id ="todoForm">
                        <input type="text" class="form-control" required placeholder="Список заданий" id = "item" name="item">
